    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/role/**","/leave-type/**","/api/leave-requests/**","/student/all-active/**","/class-subject-mark/**","/personnel/**","/attendance/**","/leave-balance/**","/academic_year/**","/leave-history/**","/receipt/report/**","/expense/**").permitAll()
